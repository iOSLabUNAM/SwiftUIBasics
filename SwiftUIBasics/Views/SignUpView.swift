...
class SignUpViewModel: ObservableObject {
    ...
    init() {
        ...
        Publishers.CombineLatest4($isValidEmail, $isValidPasswordLength,$isValidPasswordMatch, $isValidPre)
            .map { (a, b, c, d) in
                return a && b && c && d
            }
...
struct SignUpView: View {
    ...
    var body: some View {
        VStack {
            ...
            RequirementText(text: "Enter valid email", isValid: vm.isValidEmail)
                .padding()
            ...
            VStack {
                ...
                RequirementText(text: "One lowercase letter", isValid: vm.isValidPasswordUpperCase)
                RequirementText(text: "One uppercase letter", isValid: vm.isValidPasswordLowerCase)

...
class SignUpViewModel: ObservableObject {
    ...
    init() {
        ...
        Publishers.CombineLatest4($isValidPre, $isValidPasswordLowerCase,$isValidPasswordSymbolCase,$isValidPasswordNumberCase)
            .map { (a, b, c, d) in
                return a && b && c && d
            }
...
struct SignUpView: View {
    ...
    var body: some View {
        VStack {
            ...
            RequirementText(text: "Not valid email format", isValid: vm.isValidUsernameLength)
                .padding()
            ...
            VStack {
                ...
                RequirementText(text: "One symbol Character", isValid: vm.isValidPasswordSymbolCase)
                RequirementText(text: "One number", isValid: vm.isValidPasswordNumberCase)
            }
            .padding()
